...
- Exemplos:
  ...
  - Boas práticas, como: não usar caracteres especiais nos caminhos, variáveis, nomes de coluna, etc; armazenar os arquivos de forma consistente; escrever códigos que podem ser executados no seu computador e no computador de outras pessoas também.
